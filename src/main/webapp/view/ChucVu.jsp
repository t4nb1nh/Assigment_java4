    ...
    <table class="table">
        ...
        <c:forEach items="${l}" var="l">
            <tr>
                ...
                <td>
                    <button type="button" class="btn btn-outline-primary"><a href="/chuc-vu/detail?id=${l.id}">detail</a></button>
                    <button type="button" class="btn btn-outline-primary"><a href="/chuc-vu/delete?id=${l.id}">delete</a></button>
                </td>
            </tr>
        </c:forEach>
    </table>
